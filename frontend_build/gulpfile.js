...
gulp.task('postgres:load_data', function(){
  client.connect(function(err) {
      ...
      client.query('DELETE FROM reports_ResponsePlan');
      for (var i=1; i<FILTER_COUNT + 1; i++) {
        query = client.query("INSERT INTO reports_ResponsePlan (id, name, from_date, to_date) VALUES (" + i + ", '" + faker.company.companyName() +  "', '2001-01-01', '2001-01-01')");
      }
