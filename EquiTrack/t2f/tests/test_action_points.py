...
class ActionPoints(URLAssertionMixin, APITenantTestCase):
    ...
    def test_filtering(self):
        ...
        ActionPointFactory(travel=self.travel, person_responsible=self.traveler, assigned_by=self.traveler, status='completed')
        ActionPointFactory(travel=self.travel, person_responsible=self.traveler, assigned_by=self.traveler, status='ongoing')
