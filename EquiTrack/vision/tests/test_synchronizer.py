...
class TestVisionDataLoader(APITenantTestCase):
...
class TestVisionDataSynchronizerInit(APITenantTestCase):
...
class TestVisionDataSynchronizerSync(APITenantTestCase):
