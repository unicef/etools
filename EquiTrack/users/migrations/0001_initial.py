...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trips.Office'])),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Sector'])),
        ...
        # Adding model 'EquiTrackRegistrationModel'
        db.create_table(u'users_equitrackregistrationmodel', (
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trips.Office']"}),
            'phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reports.Sector']"}),
