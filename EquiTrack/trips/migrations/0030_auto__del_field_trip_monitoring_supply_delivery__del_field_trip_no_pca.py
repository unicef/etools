...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trip.monitoring_supply_delivery'
        db.delete_column(u'trips_trip', 'monitoring_supply_delivery')

        # Deleting field 'Trip.no_pca'
        db.delete_column(u'trips_trip', 'no_pca')


    def backwards(self, orm):
        # Adding field 'Trip.monitoring_supply_delivery'
        db.add_column(u'trips_trip', 'monitoring_supply_delivery',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.no_pca'
        db.add_column(u'trips_trip', 'no_pca',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
