...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.ta_trip_took_place_as_planned'
        db.add_column(u'trips_trip', 'ta_trip_took_place_as_planned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.ta_trip_took_place_as_planned'
        db.delete_column(u'trips_trip', 'ta_trip_took_place_as_planned')
