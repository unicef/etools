...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trip.ta_approved'
        db.delete_column(u'trips_trip', 'ta_approved')

        # Deleting field 'Trip.ta_approved_date'
        db.delete_column(u'trips_trip', 'ta_approved_date')

        # Deleting field 'Trip.vision_administrator'
        db.delete_column(u'trips_trip', 'vision_administrator_id')

        # Adding field 'Trip.ta_drafted'
        db.add_column(u'trips_trip', 'ta_drafted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.ta_drafted_date'
        db.add_column(u'trips_trip', 'ta_drafted_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Trip.ta_approved'
        db.add_column(u'trips_trip', 'ta_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.ta_approved_date'
        db.add_column(u'trips_trip', 'ta_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.vision_administrator'
        db.add_column(u'trips_trip', 'vision_administrator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Trip.ta_drafted'
        db.delete_column(u'trips_trip', 'ta_drafted')

        # Deleting field 'Trip.ta_drafted_date'
        db.delete_column(u'trips_trip', 'ta_drafted_date')
