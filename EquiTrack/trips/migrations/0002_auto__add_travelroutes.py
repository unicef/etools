...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TravelRoutes'
        db.create_table(u'trips_travelroutes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trip_report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trips.TripReport'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'trips', ['TravelRoutes'])


    def backwards(self, orm):
        # Deleting model 'TravelRoutes'
        db.delete_table(u'trips_travelroutes')
