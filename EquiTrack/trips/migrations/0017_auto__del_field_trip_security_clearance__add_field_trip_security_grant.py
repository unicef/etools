...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trip.security_granted'
        db.add_column(u'trips_trip', 'security_granted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.date_supervisor_approved'
        db.add_column(u'trips_trip', 'date_supervisor_approved',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.date_budget_owner_approved'
        db.add_column(u'trips_trip', 'date_budget_owner_approved',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.date_human_resources_approved'
        db.add_column(u'trips_trip', 'date_human_resources_approved',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.date_representative_approved'
        db.add_column(u'trips_trip', 'date_representative_approved',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Trip.approved_by_human_resources'
        db.alter_column(u'trips_trip', 'approved_by_human_resources', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Trip.representative_approval'
        db.alter_column(u'trips_trip', 'representative_approval', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Trip.security_granted'
        db.delete_column(u'trips_trip', 'security_granted')

        # Deleting field 'Trip.date_supervisor_approved'
        db.delete_column(u'trips_trip', 'date_supervisor_approved')

        # Deleting field 'Trip.date_budget_owner_approved'
        db.delete_column(u'trips_trip', 'date_budget_owner_approved')

        # Deleting field 'Trip.date_human_resources_approved'
        db.delete_column(u'trips_trip', 'date_human_resources_approved')

        # Deleting field 'Trip.date_representative_approved'
        db.delete_column(u'trips_trip', 'date_representative_approved')


        # Changing field 'Trip.approved_by_human_resources'
        db.alter_column(u'trips_trip', 'approved_by_human_resources', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Trip.representative_approval'
        db.alter_column(u'trips_trip', 'representative_approval', self.gf('django.db.models.fields.BooleanField')())
