...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.vision_approver'
        db.add_column(u'trips_trip', 'vision_approver',
    ...
    def backwards(self, orm):
        # Deleting field 'Trip.vision_approver'
        db.delete_column(u'trips_trip', 'vision_approver_id')
    ...
    models = {
        ...
        u'trips.trip': {
            ...
            'vision_administrator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
