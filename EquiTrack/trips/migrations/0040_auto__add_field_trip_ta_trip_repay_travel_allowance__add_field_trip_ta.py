...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.ta_trip_repay_travel_allowance'
        db.add_column(u'trips_trip', 'ta_trip_repay_travel_allowance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.ta_trip_final_claim'
        db.add_column(u'trips_trip', 'ta_trip_final_claim',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.ta_trip_repay_travel_allowance'
        db.delete_column(u'trips_trip', 'ta_trip_repay_travel_allowance')

        # Deleting field 'Trip.ta_trip_final_claim'
        db.delete_column(u'trips_trip', 'ta_trip_final_claim')
