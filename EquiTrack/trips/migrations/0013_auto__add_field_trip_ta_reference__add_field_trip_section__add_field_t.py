...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.ta_reference'
        db.add_column(u'trips_trip', 'ta_reference',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.section'
        db.add_column(u'trips_trip', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Sector'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trip.security_clearance'
        db.add_column(u'trips_trip', 'security_clearance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Trip.created_date'
        db.add_column(u'trips_trip', 'created_date',
        ...
        # Adding field 'ActionPoint.comments'
        db.add_column(u'trips_actionpoint', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'TravelRoutes.origin'
        db.add_column(u'trips_travelroutes', 'origin',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254),
                      keep_default=False)

        # Adding field 'TravelRoutes.destination'
        db.add_column(u'trips_travelroutes', 'destination',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'trips_trip', 'ta_reference')

        # Deleting field 'Trip.section'
        db.delete_column(u'trips_trip', 'section_id')

        # Deleting field 'Trip.security_clearance'
        db.delete_column(u'trips_trip', 'security_clearance')

        # Deleting field 'Trip.created_date'
        db.delete_column(u'trips_trip', 'created_date')
        ...
        # Deleting field 'ActionPoint.actions_taken'
        db.delete_column(u'trips_actionpoint', 'actions_taken')

        # Deleting field 'ActionPoint.comments'
        db.delete_column(u'trips_actionpoint', 'comments')


        # User chose to not deal with backwards NULL issues for 'TravelRoutes.route'
        raise RuntimeError("Cannot reverse this migration. 'TravelRoutes.route' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TravelRoutes.route'
        db.add_column(u'trips_travelroutes', 'route',
                      self.gf('django.db.models.fields.CharField')(max_length=254),
                      keep_default=False)

        # Deleting field 'TravelRoutes.origin'
        db.delete_column(u'trips_travelroutes', 'origin')

        # Deleting field 'TravelRoutes.destination'
        db.delete_column(u'trips_travelroutes', 'destination')


        # Changing field 'TravelRoutes.arrive'
        db.alter_column(u'trips_travelroutes', 'arrive', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'TravelRoutes.depart'
        db.alter_column(u'trips_travelroutes', 'depart', self.gf('django.db.models.fields.TimeField')())
    ...
    models = {
        ...
        u'trips.trip': {
            ...
            'travel_assistant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'organised_trips'", 'to': u"orm['auth.User']"}),
