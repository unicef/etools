...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.cancelled_reason'
        db.add_column(u'trips_trip', 'cancelled_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.cancelled_reason'
        db.delete_column(u'trips_trip', 'cancelled_reason')
