...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.travel_assistant'
        db.add_column(u'trips_trip', 'travel_assistant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organised_trips', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Trip.transport_booked'
        db.add_column(u'trips_trip', 'transport_booked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.travel_assistant'
        db.delete_column(u'trips_trip', 'travel_assistant_id')

        # Deleting field 'Trip.transport_booked'
        db.delete_column(u'trips_trip', 'transport_booked')
