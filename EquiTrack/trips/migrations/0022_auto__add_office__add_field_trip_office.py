...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Office'
        db.create_table(u'trips_office', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254)),
        ))
        db.send_create_signal(u'trips', ['Office'])

        # Adding field 'Trip.office'
        db.add_column(u'trips_trip', 'office',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'trips_office')

        # Deleting field 'Trip.office'
        db.delete_column(u'trips_trip', 'office_id')
