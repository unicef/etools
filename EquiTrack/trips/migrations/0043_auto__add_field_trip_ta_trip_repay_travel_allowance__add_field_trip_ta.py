...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Office.location'
        db.add_column(u'trips_office', 'location',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Office.location'
        db.delete_column(u'trips_office', 'location_id')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#0EF656'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
