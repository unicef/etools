...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.security_clearance_required'
        db.add_column(u'trips_trip', 'security_clearance_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.security_clearance_required'
        db.delete_column(u'trips_trip', 'security_clearance_required')
