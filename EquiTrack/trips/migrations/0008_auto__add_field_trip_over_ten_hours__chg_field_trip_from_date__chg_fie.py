...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.over_ten_hours'
        db.add_column(u'trips_trip', 'over_ten_hours',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Trip.from_date'
        db.alter_column(u'trips_trip', 'from_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Trip.to_date'
        db.alter_column(u'trips_trip', 'to_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Trip.over_ten_hours'
        db.delete_column(u'trips_trip', 'over_ten_hours')


        # Changing field 'Trip.from_date'
        db.alter_column(u'trips_trip', 'from_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Trip.to_date'
        db.alter_column(u'trips_trip', 'to_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'trips.trip': {
            ...
            'over_ten_hours': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
