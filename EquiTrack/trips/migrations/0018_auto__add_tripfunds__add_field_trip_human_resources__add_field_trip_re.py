...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TripFunds'
        db.create_table(u'trips_tripfunds', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trips.Trip'])),
            ('wbs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.WBS'])),
        ...
        db.send_create_signal(u'trips', ['TripFunds'])

        # Adding field 'Trip.human_resources'
        db.add_column(u'trips_trip', 'human_resources',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='certified_trips', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Trip.representative'
        db.add_column(u'trips_trip', 'representative',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='approved_trips', null=True, to=orm['auth.User']),
                      keep_default=False)
        ...
        # Changing field 'Trip.budget_owner'
        db.alter_column(u'trips_trip', 'budget_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Trip.supervisor'
        db.alter_column(u'trips_trip', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'TravelRoutes.remarks'
        db.add_column(u'trips_travelroutes', 'remarks',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TripFunds'
        db.delete_table(u'trips_tripfunds')

        # Deleting field 'Trip.human_resources'
        db.delete_column(u'trips_trip', 'human_resources_id')

        # Deleting field 'Trip.representative'
        db.delete_column(u'trips_trip', 'representative_id')
        ...
        # User chose to not deal with backwards NULL issues for 'Trip.budget_owner'
        raise RuntimeError("Cannot reverse this migration. 'Trip.budget_owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Trip.budget_owner'
        db.alter_column(u'trips_trip', 'budget_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Trip.supervisor'
        raise RuntimeError("Cannot reverse this migration. 'Trip.supervisor' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Trip.supervisor'
        db.alter_column(u'trips_trip', 'supervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'TravelRoutes.remarks'
        db.delete_column(u'trips_travelroutes', 'remarks')
    ...
    models = {
        ...
        u'trips.trip': {
            ...
            'supervisor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'supervised_trips'", 'null': 'True', 'to': u"orm['auth.User']"}),
