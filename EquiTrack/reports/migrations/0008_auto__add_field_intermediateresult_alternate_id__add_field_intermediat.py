...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntermediateResult.alternate_id'
        db.add_column(u'reports_intermediateresult', 'alternate_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IntermediateResult.alternate_name'
        db.add_column(u'reports_intermediateresult', 'alternate_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.alternate_id'
        db.add_column(u'reports_activity', 'alternate_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.alternate_name'
        db.add_column(u'reports_activity', 'alternate_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.alternate_id'
        db.add_column(u'reports_sector', 'alternate_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.alternate_name'
        db.add_column(u'reports_sector', 'alternate_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntermediateResult.alternate_id'
        db.delete_column(u'reports_intermediateresult', 'alternate_id')

        # Deleting field 'IntermediateResult.alternate_name'
        db.delete_column(u'reports_intermediateresult', 'alternate_name')

        # Deleting field 'Activity.alternate_id'
        db.delete_column(u'reports_activity', 'alternate_id')

        # Deleting field 'Activity.alternate_name'
        db.delete_column(u'reports_activity', 'alternate_name')

        # Deleting field 'Sector.alternate_id'
        db.delete_column(u'reports_sector', 'alternate_id')

        # Deleting field 'Sector.alternate_name'
        db.delete_column(u'reports_sector', 'alternate_name')
