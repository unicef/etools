    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ll_results', to='partners.InterventionResultLink')),
            ],
            options={
                'ordering': ('-created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Outcome', 'Outcome'), ('Output', 'Output'), ('Activity', 'Activity')], max_length=150, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Sector',
