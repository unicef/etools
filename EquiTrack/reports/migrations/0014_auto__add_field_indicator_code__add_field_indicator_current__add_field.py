...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.code'
        db.add_column(u'reports_indicator', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Indicator.current'
        db.add_column(u'reports_indicator', 'current',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Result.code'
        db.add_column(u'reports_result', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.code'
        db.delete_column(u'reports_indicator', 'code')

        # Deleting field 'Indicator.current'
        db.delete_column(u'reports_indicator', 'current')

        # Deleting field 'Result.code'
        db.delete_column(u'reports_result', 'code')
