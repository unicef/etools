...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.result_structure'
        db.add_column(u'reports_goal', 'result_structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.ResultStructure'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.result_structure'
        db.delete_column(u'reports_goal', 'result_structure_id')
