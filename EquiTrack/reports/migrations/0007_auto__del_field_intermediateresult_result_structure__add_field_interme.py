...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IntermediateResult.from_date'
        db.add_column(u'reports_intermediateresult', 'from_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 18, 0, 0)),
                      keep_default=False)

        # Adding field 'IntermediateResult.to_date'
        db.add_column(u'reports_intermediateresult', 'to_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 18, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'IntermediateResult.from_date'
        db.delete_column(u'reports_intermediateresult', 'from_date')

        # Deleting field 'IntermediateResult.to_date'
        db.delete_column(u'reports_intermediateresult', 'to_date')
