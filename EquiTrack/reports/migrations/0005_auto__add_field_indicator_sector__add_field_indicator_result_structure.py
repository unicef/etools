...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.sector'
        db.add_column(u'reports_indicator', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reports.Sector']),
                      keep_default=False)

        # Adding field 'Indicator.result_structure'
        db.add_column(u'reports_indicator', 'result_structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.ResultStructure'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.sector'
        db.delete_column(u'reports_indicator', 'sector_id')

        # Deleting field 'Indicator.result_structure'
        db.delete_column(u'reports_indicator', 'result_structure_id')
