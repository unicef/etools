...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.sector_total'
        db.add_column(u'reports_indicator', 'sector_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Indicator.sector_current'
        db.add_column(u'reports_indicator', 'sector_current',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.sector_total'
        db.delete_column(u'reports_indicator', 'sector_total')

        # Deleting field 'Indicator.sector_current'
        db.delete_column(u'reports_indicator', 'sector_current')
