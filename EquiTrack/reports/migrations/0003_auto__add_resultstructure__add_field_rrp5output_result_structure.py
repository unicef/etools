...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rrp5Output.result_structure'
        db.add_column(u'reports_rrp5output', 'result_structure',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Rrp5Output.result_structure'
        db.delete_column(u'reports_rrp5output', 'result_structure_id')
