...
class InterventionListAPIView(ExportModelMixin, ValidatorViewMixin, ListCreateAPIView):
    ...
    def get_serializer_class(self):
        ...
        if self.request.method == "GET":
            ...
            if "verbosity" in list(query_params.keys()):
    ...
    def get_queryset(self, format=None):
        ...
        if query_params:
            queries = []
            if "values" in list(query_params.keys()):
            ...
            if "unicef_focal_points" in list(query_params.keys()):
            ...
            if "office" in list(query_params.keys()):
                queries.append(Q(offices__in=[query_params.get("office")]))
            if "location" in list(query_params.keys()):
...
class InterventionListMapView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        if query_params:
            ...
            if "partner" in list(query_params.keys()):
