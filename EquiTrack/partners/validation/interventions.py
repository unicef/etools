...
def start_date_signed_valid(i):
    # i = intervention
    if i.signed_by_unicef_date and i.signed_by_partner_date and i.start and i.signed_pd_attachment.exists():
...
def start_date_related_agreement_valid(i):
    ...
    if i.document_type in [i.PD, i.SHPD] and not i.contingency_pd and i.start and i.agreement.start and \
            i.signed_pd_attachment.exists() and i.start < i.agreement.start:
        return False
    return True
