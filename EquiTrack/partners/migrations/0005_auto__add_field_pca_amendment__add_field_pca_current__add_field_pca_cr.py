...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PCA.amendment'
        db.add_column(u'partners_pca', 'amendment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PCA.current'
        db.add_column(u'partners_pca', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PCA.created_at'
        db.add_column(u'partners_pca', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PCA.updated_at'
        db.add_column(u'partners_pca', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PCA.versioned_at'
        db.add_column(u'partners_pca', 'versioned_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'PCA.initiation_date'
        db.alter_column(u'partners_pca', 'initiation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 12, 17, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'PCA.amendment'
        db.delete_column(u'partners_pca', 'amendment')

        # Deleting field 'PCA.current'
        db.delete_column(u'partners_pca', 'current')

        # Deleting field 'PCA.created_at'
        db.delete_column(u'partners_pca', 'created_at')

        # Deleting field 'PCA.updated_at'
        db.delete_column(u'partners_pca', 'updated_at')

        # Deleting field 'PCA.versioned_at'
        db.delete_column(u'partners_pca', 'versioned_at')


        # Changing field 'PCA.initiation_date'
        db.alter_column(u'partners_pca', 'initiation_date', self.gf('django.db.models.fields.DateField')(null=True))
