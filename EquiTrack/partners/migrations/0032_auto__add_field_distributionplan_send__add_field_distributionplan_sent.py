...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DistributionPlan.sent'
        db.add_column(u'partners_distributionplan', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DistributionPlan.delivered'
        db.add_column(u'partners_distributionplan', 'delivered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'PartnerOrganization.core_values_assessment'
        db.alter_column(u'partners_partnerorganization', 'core_values_assessment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'DistributionPlan.send'
        db.delete_column(u'partners_distributionplan', 'send')

        # Deleting field 'DistributionPlan.sent'
        db.delete_column(u'partners_distributionplan', 'sent')

        # Deleting field 'DistributionPlan.delivered'
        db.delete_column(u'partners_distributionplan', 'delivered')

        # Adding unique constraint on 'PartnerOrganization', fields ['short_name']
        db.create_unique(u'partners_partnerorganization', ['short_name'])


        # User chose to not deal with backwards NULL issues for 'PartnerOrganization.core_values_assessment'
        raise RuntimeError("Cannot reverse this migration. 'PartnerOrganization.core_values_assessment' and its values cannot be restored.")
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#78E08A'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#B25D00'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#BA9CD5'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
