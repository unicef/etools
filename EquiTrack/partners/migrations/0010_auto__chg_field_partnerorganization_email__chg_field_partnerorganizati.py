...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerOrganization.email'
        db.alter_column(u'partners_partnerorganization', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PartnerOrganization.contact_person'
        db.alter_column(u'partners_partnerorganization', 'contact_person', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PartnerOrganization.name'
        db.alter_column(u'partners_partnerorganization', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'PartnerOrganization.email'
        db.alter_column(u'partners_partnerorganization', 'email', self.gf('django.db.models.fields.CharField')(max_length=128L))

        # Changing field 'PartnerOrganization.contact_person'
        db.alter_column(u'partners_partnerorganization', 'contact_person', self.gf('django.db.models.fields.CharField')(max_length=64L))

        # Changing field 'PartnerOrganization.name'
        db.alter_column(u'partners_partnerorganization', 'name', self.gf('django.db.models.fields.CharField')(max_length=45L, unique=True))
