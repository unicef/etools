...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GwPCALocation.tpm_visit'
        db.add_column(u'partners_gwpcalocation', 'tpm_visit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GwPCALocation.tpm_visit'
        db.delete_column(u'partners_gwpcalocation', 'tpm_visit')
