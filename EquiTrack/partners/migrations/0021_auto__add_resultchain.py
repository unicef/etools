...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResultChain'
        db.create_table(u'partners_resultchain', (
            ...
            ('result', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['reports.Result'])),
            ('indicator', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['reports.Indicator'])),
            ('governerate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Governorate'], null=True, blank=True)),
            ('programmed', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'partners', ['ResultChain'])


    def backwards(self, orm):
        # Deleting model 'ResultChain'
        db.delete_table(u'partners_resultchain')
