...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SupplyPlan'
        db.create_table(u'partners_supplyplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partnership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='supply_plans', to=orm['partners.PCA'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['supplies.SupplyItem'])),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'partners', ['SupplyPlan'])

        # Adding model 'DistributionPlan'
        db.create_table(u'partners_distributionplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partnership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='distribution_plans', to=orm['partners.PCA'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['supplies.SupplyItem'])),
    ...
    def backwards(self, orm):
        # Deleting model 'SupplyPlan'
        db.delete_table(u'partners_supplyplan')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#11E5DA'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#241C54'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#2FDED7'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
