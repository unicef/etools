...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PCA.result_structure'
        db.add_column(u'partners_pca', 'result_structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.ResultStructure'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'PCA.amendment'
        db.alter_column(u'partners_pca', 'amendment', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Deleting field 'PCA.result_structure'
        db.delete_column(u'partners_pca', 'result_structure_id')


        # Changing field 'PCA.amendment'
        db.alter_column(u'partners_pca', 'amendment', self.gf('django.db.models.fields.NullBooleanField')(null=True))
