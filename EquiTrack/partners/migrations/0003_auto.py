...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field unicef_managers on 'PCA'
        m2m_table_name = db.shorten_name(u'partners_pca_unicef_managers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pca', models.ForeignKey(orm[u'partners.pca'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pca_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field unicef_managers on 'PCA'
        db.delete_table(db.shorten_name(u'partners_pca_unicef_managers'))
