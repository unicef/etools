...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'partners_pca', 'initiation_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'PCA.initiation_date'
        db.alter_column(u'partners_pca', 'initiation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
