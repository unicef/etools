...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'partners_assessment', (
            ...
            ('rating', self.gf('django.db.models.fields.CharField')(default=u'high', max_length=50)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True)),
        ))
        db.send_create_signal(u'partners', ['Assessment'])

        # Adding field 'PartnerOrganization.type'
        db.add_column(u'partners_partnerorganization', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'national', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Assessment'
        db.delete_table(u'partners_assessment')

        # Deleting field 'PartnerOrganization.type'
        db.delete_column(u'partners_partnerorganization', 'type')
