...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PartnerOrganization', fields ['name']
        db.create_unique(u'partners_partnerorganization', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'PartnerOrganization', fields ['name']
        db.delete_unique(u'partners_partnerorganization', ['name'])
