...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for file in orm.PCAFile.objects.all():
            file.attachment = file.file.file
            file.save()
            migrated_files += 1
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#98C63D'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#9B8790'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#2C251D'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
