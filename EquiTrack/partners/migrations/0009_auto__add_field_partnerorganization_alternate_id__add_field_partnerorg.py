...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerOrganization.alternate_id'
        db.add_column(u'partners_partnerorganization', 'alternate_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PartnerOrganization.alternate_name'
        db.add_column(u'partners_partnerorganization', 'alternate_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerOrganization.alternate_id'
        db.delete_column(u'partners_partnerorganization', 'alternate_id')

        # Deleting field 'PartnerOrganization.alternate_name'
        db.delete_column(u'partners_partnerorganization', 'alternate_name')
