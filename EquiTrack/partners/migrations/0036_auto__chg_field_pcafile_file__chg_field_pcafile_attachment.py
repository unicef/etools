...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PCAFile.file'
        db.alter_column(u'partners_pcafile', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

        # Changing field 'PCAFile.attachment'
        db.alter_column(u'partners_pcafile', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PCAFile.file'
        raise RuntimeError("Cannot reverse this migration. 'PCAFile.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PCAFile.file'
        db.alter_column(u'partners_pcafile', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # Changing field 'PCAFile.attachment'
        db.alter_column(u'partners_pcafile', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#4D5571'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#C6A46C'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#489730'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.pcafile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pca': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachments'", 'to': u"orm['partners.PCA']"}),
