...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'partners_actionpoint')

        # Removing M2M table for field persons_responsible on 'ActionPoint'
        db.delete_table(db.shorten_name(u'partners_actionpoint_persons_responsible'))

        # Adding model 'Recommendation'
        db.create_table(u'partners_recommendation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assessment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Assessment'])),
            ('subject_area', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'partners', ['Recommendation'])

        # Adding field 'PartnerOrganization.address'
        db.add_column(u'partners_partnerorganization', 'address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PartnerOrganization.vendor_number'
        db.add_column(u'partners_partnerorganization', 'vendor_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.requested_date'
        db.add_column(u'partners_assessment', 'requested_date',
        ...
        # Adding field 'Assessment.names_of_other_agencies'
        db.add_column(u'partners_assessment', 'names_of_other_agencies',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.expected_budget'
        db.add_column(u'partners_assessment', 'expected_budget',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Assessment.requesting_officer'
        db.add_column(u'partners_assessment', 'requesting_officer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='requested_assessments', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Assessment.approving_officer'
        db.add_column(u'partners_assessment', 'approving_officer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Assessment.planned_date'
        db.alter_column(u'partners_assessment', 'planned_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Adding model 'ActionPoint'
        db.create_table(u'partners_actionpoint', (
        ...
        db.send_create_signal(u'partners', ['ActionPoint'])

        # Adding M2M table for field persons_responsible on 'ActionPoint'
        m2m_table_name = db.shorten_name(u'partners_actionpoint_persons_responsible')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actionpoint', models.ForeignKey(orm[u'partners.actionpoint'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['actionpoint_id', 'user_id'])

        # Deleting model 'Recommendation'
        db.delete_table(u'partners_recommendation')

        # Deleting field 'PartnerOrganization.address'
        db.delete_column(u'partners_partnerorganization', 'address')

        # Deleting field 'PartnerOrganization.vendor_number'
        db.delete_column(u'partners_partnerorganization', 'vendor_number')

        # Deleting field 'Assessment.requested_date'
        db.delete_column(u'partners_assessment', 'requested_date')

        # Deleting field 'Assessment.previous_value_with_UN'
        db.delete_column(u'partners_assessment', 'previous_value_with_UN')

        # Deleting field 'Assessment.names_of_other_agencies'
        db.delete_column(u'partners_assessment', 'names_of_other_agencies')

        # Deleting field 'Assessment.expected_budget'
        db.delete_column(u'partners_assessment', 'expected_budget')

        # Deleting field 'Assessment.requesting_officer'
        db.delete_column(u'partners_assessment', 'requesting_officer_id')

        # Deleting field 'Assessment.approving_officer'
        db.delete_column(u'partners_assessment', 'approving_officer_id')


        # User chose to not deal with backwards NULL issues for 'Assessment.planned_date'
        raise RuntimeError("Cannot reverse this migration. 'Assessment.planned_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Assessment.planned_date'
        db.alter_column(u'partners_assessment', 'planned_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'partners.assessment': {
            ...
            'requested_date': ('django.db.models.fields.DateField', [], {}),
        ...
        u'partners.face': {
            ...
            'amount': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100'}),
            'date_paid': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pca': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'face_refs'", 'to': u"orm['partners.PCA']"}),
            'ref': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'requested'", 'max_length': '100'}),
            'submited_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'partners.filetype': {
        ...
        u'partners.partnerorganization': {
            ...
            'vendor_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'partners.pca': {
