...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Unit', fields ['type']
        db.create_unique(u'partners_unit', ['type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Unit', fields ['type']
        db.delete_unique(u'partners_unit', ['type'])
