...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'partners_pca', 'agreement_type',
                      self.gf('django.db.models.fields.CharField')(default=u'pca', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PCA.agreement_type'
        db.delete_column(u'partners_pca', 'agreement_type')
