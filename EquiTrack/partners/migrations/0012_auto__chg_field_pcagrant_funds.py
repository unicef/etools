...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PcaGrant.funds'
        db.alter_column(u'partners_pcagrant', 'funds', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PcaGrant.funds'
        db.alter_column(u'partners_pcagrant', 'funds', self.gf('django.db.models.fields.IntegerField')(default=0))
