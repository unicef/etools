...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'partners_sector', 'description', self.gf('django.db.models.fields.CharField')(max_length=256L, null=True))

    def backwards(self, orm):

        # Changing field 'Sector.description'
        db.alter_column(u'partners_sector', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=256L))
