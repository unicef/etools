...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResultChain.result_structure'
        db.delete_column(u'partners_resultchain', 'result_structure_id')

        # Deleting field 'ResultChain.programmed'
        db.delete_column(u'partners_resultchain', 'programmed')

        # Adding field 'ResultChain.result_type'
        db.add_column(u'partners_resultchain', 'result_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reports.ResultType']),
                      keep_default=False)

        # Adding field 'ResultChain.target'
        db.add_column(u'partners_resultchain', 'target',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ResultChain.result_structure'
        raise RuntimeError("Cannot reverse this migration. 'ResultChain.result_structure' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ResultChain.result_structure'
        db.add_column(u'partners_resultchain', 'result_structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.ResultStructure']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ResultChain.programmed'
        raise RuntimeError("Cannot reverse this migration. 'ResultChain.programmed' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ResultChain.programmed'
        db.add_column(u'partners_resultchain', 'programmed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(),
                      keep_default=False)

        # Deleting field 'ResultChain.result_type'
        db.delete_column(u'partners_resultchain', 'result_type_id')

        # Deleting field 'ResultChain.target'
        db.delete_column(u'partners_resultchain', 'target')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#366593'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#30D23D'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#0E3F56'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.resultchain': {
            ...
            'governerate': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.Governorate']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
