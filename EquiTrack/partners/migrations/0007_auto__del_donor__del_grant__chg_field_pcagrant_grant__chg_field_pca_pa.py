...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PcaGrant.grant'
        db.alter_column(u'partners_pcagrant', 'grant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['funds.Grant']))

        # Changing field 'PCA.partner'
        db.alter_column(u'partners_pca', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['partners.PartnerOrganization']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PcaGrant.grant'
        db.alter_column(u'partners_pcagrant', 'grant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Grant']))

        # Changing field 'PCA.partner'
        db.alter_column(u'partners_pca', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerOrganization'], null=True))
