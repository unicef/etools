...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'partners_agreement', (
            ...
            ('agreement_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('attached_agreement', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('signed_by_unicef_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('signed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='signed_pcas', null=True, to=orm['auth.User'])),
            ('signed_by_partner_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('partner_first_name', self.gf('django.db.models.fields.CharField')(max_length=64L, blank=True)),
            ('partner_last_name', self.gf('django.db.models.fields.CharField')(max_length=64L, blank=True)),
            ('partner_email', self.gf('django.db.models.fields.CharField')(max_length=128L, blank=True)),
        ))
        db.send_create_signal(u'partners', ['Agreement'])

        # Deleting field 'PCA.agreement_type'
        db.rename_column('partners_pca', 'agreement_type', 'partnership_type')

        # Adding field 'PCA.agreement'
        db.add_column(u'partners_pca', 'agreement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Agreement'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Agreement'
        db.delete_table(u'partners_agreement')

        # Adding field 'PCA.agreement_type'
        db.rename_column('partners_pca', 'partnership_type', 'agreement_type')

        # Deleting field 'PCA.agreement'
        db.delete_column(u'partners_pca', 'agreement_id')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#D360D8'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#DDCEDF'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#03F059'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.agreement': {
            ...
            'attached_agreement': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            ...
            'signed_by_unicef_rep': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'signed_pcas'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'partners.pca': {
            ...
            'agreement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['partners.Agreement']", 'null': 'True', 'blank': 'True'}),
        ...
        u'partners.resultchain': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['reports.Indicator']"}),
