...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerOrganization.vendor_number'
        db.alter_column(u'partners_partnerorganization', 'vendor_number', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PartnerOrganization.vendor_number'
        db.alter_column(u'partners_partnerorganization', 'vendor_number', self.gf('django.db.models.fields.IntegerField')(null=True))
