...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GwPCALocation.governorate'
        db.alter_column(u'partners_gwpcalocation', 'governorate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['locations.Governorate']))

    def backwards(self, orm):

        # Changing field 'GwPCALocation.governorate'
        db.alter_column(u'partners_gwpcalocation', 'governorate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Governorate'], null=True))
