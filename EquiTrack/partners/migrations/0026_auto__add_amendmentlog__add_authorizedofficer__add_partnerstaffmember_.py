...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AmendmentLog'
        db.create_table(u'partners_amendmentlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('partnership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PCA'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('amended_at', self.gf('django.db.models.fields.DateField')(null=True)),
            ('amendment_number', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'partners', ['AmendmentLog'])

        # Adding model 'AuthorizedOfficer'
        db.create_table(u'partners_authorizedofficer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agreement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Agreement'])),
            ('officer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerStaffMember'])),
        ))
        db.send_create_signal(u'partners', ['AuthorizedOfficer'])

        # Adding model 'PartnerStaffMember'
        db.create_table(u'partners_partnerstaffmember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PartnerOrganization'])),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=64L)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=64L)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=128L)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=64L, blank=True)),
        ))
        db.send_create_signal(u'partners', ['PartnerStaffMember'])

        # Adding model 'PartnershipBudget'
        db.create_table(u'partners_partnershipbudget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('partnership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PCA'])),
            ('partner_contribution', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('unicef_cash', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('in_kind_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('amendment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='budgets', null=True, to=orm['partners.AmendmentLog'])),
        ))
        db.send_create_signal(u'partners', ['PartnershipBudget'])

        # Adding field 'PCASector.created'
        db.add_column(u'partners_pcasector', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'PCASector.modified'
        db.add_column(u'partners_pcasector', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'PCA.partner_focal_first_name'
        db.delete_column(u'partners_pca', 'partner_focal_first_name')

        # Deleting field 'PCA.partner_focal_email'
        db.delete_column(u'partners_pca', 'partner_focal_email')

        # Deleting field 'PCA.partner_focal_phone'
        db.delete_column(u'partners_pca', 'partner_focal_phone')

        # Deleting field 'PCA.partner_focal_last_name'
        db.delete_column(u'partners_pca', 'partner_focal_last_name')

        # Adding field 'PCA.review_date'
        db.add_column(u'partners_pca', 'review_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PCA.unicef_manager'
        db.add_column(u'partners_pca', 'unicef_manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='approved_partnerships', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PCA.partner_manager'
        db.add_column(u'partners_pca', 'partner_manager',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(blank=True, related_name='signed_partnerships', null=True, to=orm['partners.PartnerStaffMember']),
                      keep_default=False)

        # Adding field 'PCA.partner_focal_point'
        db.add_column(u'partners_pca', 'partner_focal_point',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(blank=True, related_name='my_partnerships', null=True, to=orm['partners.PartnerStaffMember']),
                      keep_default=False)

        # Renaming field 'PCAGrant.pca'
        db.rename_column(u'partners_pcagrant', 'pca_id', 'partnership_id')

        # Adding field 'PCAGrant.created'
        db.add_column(u'partners_pcagrant', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'PCAGrant.modified'
        db.add_column(u'partners_pcagrant', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'PCAGrant.amendment'
        db.add_column(u'partners_pcagrant', 'amendment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='grants', null=True, to=orm['partners.AmendmentLog']),
                      keep_default=False)

        # Deleting field 'Agreement.partner_email'
        db.delete_column(u'partners_agreement', 'partner_email')

        # Deleting field 'Agreement.partner_first_name'
        db.delete_column(u'partners_agreement', 'partner_first_name')

        # Deleting field 'Agreement.partner_last_name'
        db.delete_column(u'partners_agreement', 'partner_last_name')

        # Adding field 'Agreement.partner_manager'
        db.add_column(u'partners_agreement', 'partner_manager',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['partners.PartnerStaffMember'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AmendmentLog'
        db.delete_table(u'partners_amendmentlog')

        # Deleting model 'AuthorizedOfficer'
        db.delete_table(u'partners_authorizedofficer')

        # Deleting model 'PartnerStaffMember'
        db.delete_table(u'partners_partnerstaffmember')

        # Deleting model 'PartnershipBudget'
        db.delete_table(u'partners_partnershipbudget')

        # Deleting field 'PCASector.created'
        db.delete_column(u'partners_pcasector', 'created')

        # Deleting field 'PCASector.modified'
        db.delete_column(u'partners_pcasector', 'modified')

        # Adding field 'PCA.partner_focal_first_name'
        db.add_column(u'partners_pca', 'partner_focal_first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64L, blank=True),
                      keep_default=False)

        # Adding field 'PCA.partner_focal_email'
        db.add_column(u'partners_pca', 'partner_focal_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128L, blank=True),
                      keep_default=False)

        # Adding field 'PCA.partner_focal_phone'
        db.add_column(u'partners_pca', 'partner_focal_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64L, blank=True),
                      keep_default=False)

        # Adding field 'PCA.partner_focal_last_name'
        db.add_column(u'partners_pca', 'partner_focal_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64L, blank=True),
                      keep_default=False)

        # Deleting field 'PCA.review_date'
        db.delete_column(u'partners_pca', 'review_date')

        # Deleting field 'PCA.unicef_manager'
        db.delete_column(u'partners_pca', 'unicef_manager_id')

        # Deleting field 'PCA.partner_manager'
        db.delete_column(u'partners_pca', 'partner_manager_id')

        # Deleting field 'PCA.partner_focal_point'
        db.delete_column(u'partners_pca', 'partner_focal_point_id')
        
        # Renaming field 'PCAGrant.partnership'
        db.rename_column(u'partners_pcagrant', 'partnership_id', 'pca_id')

        # Deleting field 'PCAGrant.created'
        db.delete_column(u'partners_pcagrant', 'created')

        # Deleting field 'PCAGrant.modified'
        db.delete_column(u'partners_pcagrant', 'modified')

        # Deleting field 'PCAGrant.amendment'
        db.delete_column(u'partners_pcagrant', 'amendment_id')

        # Adding field 'Agreement.partner_email'
        db.add_column(u'partners_agreement', 'partner_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128L, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.partner_first_name'
        db.add_column(u'partners_agreement', 'partner_first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64L, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.partner_last_name'
        db.add_column(u'partners_agreement', 'partner_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64L, blank=True),
                      keep_default=False)

        # Deleting field 'Agreement.partner_manager'
        db.delete_column(u'partners_agreement', 'partner_manager_id')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#33CBFA'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#517839'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#FFF77B'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.authorizedofficer': {
            ...
            'agreement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['partners.Agreement']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'partners.partnershipbudget': {
            ...
            'amendment': ('smart_selects.db_fields.ChainedForeignKey', [], {'blank': 'True', 'related_name': "'budgets'", 'null': 'True', 'to': u"orm['partners.AmendmentLog']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'partners.pcagrant': {
            ...
            'amendment': ('smart_selects.db_fields.ChainedForeignKey', [], {'blank': 'True', 'related_name': "'grants'", 'null': 'True', 'to': u"orm['partners.AmendmentLog']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
