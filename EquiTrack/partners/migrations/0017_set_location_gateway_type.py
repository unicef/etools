...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # set location types
        for pca_loc in orm.GwPcaLocation.objects.all():
            location = pca_loc.location
            location.gateway = pca_loc.gateway
            location.save()
            if location.gateway != pca_loc.gateway:
                print '{}: {} != {}'.format(
                    pca_loc.pca.number,
                    pca_loc.gateway.name,
