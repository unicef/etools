...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'partners_intermediateresult', (
        ...
        db.send_create_signal(u'partners', ['IntermediateResult'])

        # Adding model 'WBS'
        db.create_table(u'partners_wbs', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'partners', ['WBS'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'partners_intermediateresult')

        # Deleting model 'WBS'
        db.delete_table(u'partners_wbs')
