...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GwPCALocation.region'
        db.alter_column(u'partners_gwpcalocation', 'region_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['locations.Region'], null=True))

    def backwards(self, orm):

        # Changing field 'GwPCALocation.locality'
        db.alter_column(u'partners_gwpcalocation', 'locality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Locality'], null=True))

        # Changing field 'GwPCALocation.region'
        db.alter_column(u'partners_gwpcalocation', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Region'], null=True))
    ...
    models = {
        ...
        u'partners.gwpcalocation': {
            ...
            'region': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['locations.Region']", 'null': 'True', 'blank': 'True'})
        },
