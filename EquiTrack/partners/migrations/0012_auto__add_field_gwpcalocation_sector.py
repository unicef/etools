...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GwPCALocation.sector'
        db.add_column(u'partners_gwpcalocation', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Sector'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GwPCALocation.sector'
        db.delete_column(u'partners_gwpcalocation', 'sector_id')
