...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndicatorProgress.indicator'
        db.add_column(u'partners_indicatorprogress', 'indicator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['partners.Indicator']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndicatorProgress.indicator'
        db.delete_column(u'partners_indicatorprogress', 'indicator_id')
