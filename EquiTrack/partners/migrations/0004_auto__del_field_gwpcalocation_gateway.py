...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GwPCALocation.gateway'
        db.delete_column(u'partners_gwpcalocation', 'gateway_id')


    def backwards(self, orm):
        # Adding field 'GwPCALocation.gateway'
        db.add_column(u'partners_gwpcalocation', 'gateway',
