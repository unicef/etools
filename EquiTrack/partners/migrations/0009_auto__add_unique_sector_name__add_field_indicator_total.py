...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sector', fields ['name']
        db.create_unique(u'partners_sector', ['name'])

        # Adding field 'Indicator.total'
        db.add_column(u'partners_indicator', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Sector', fields ['name']
        db.delete_unique(u'partners_sector', ['name'])

        # Deleting field 'Indicator.total'
        db.delete_column(u'partners_indicator', 'total')
