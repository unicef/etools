...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Assessment.actions'
        db.delete_column(u'partners_assessment', 'actions')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Assessment.actions'
        db.add_column(u'partners_assessment', 'actions',
    ...
    models = {
        ...
        u'partners.actionpoint': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'persons_responsible': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'follow_ups'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
