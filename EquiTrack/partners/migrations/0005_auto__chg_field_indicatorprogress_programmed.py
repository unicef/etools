...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndicatorProgress.programmed'
        db.alter_column(u'partners_indicatorprogress', 'programmed', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'IndicatorProgress.programmed'
        db.alter_column(u'partners_indicatorprogress', 'programmed', self.gf('django.db.models.fields.IntegerField')())
