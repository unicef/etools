...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpotCheck.sector'
        db.add_column(u'partners_spotcheck', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reports.Sector']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpotCheck.sector'
        db.delete_column(u'partners_spotcheck', 'sector_id')
