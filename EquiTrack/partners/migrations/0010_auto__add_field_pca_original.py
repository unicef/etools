...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PCA.original'
        db.add_column(u'partners_pca', 'original',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.PCA'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PCA.original'
        db.delete_column(u'partners_pca', 'original_id')
    ...
    models = {
        ...
        u'partners.pca': {
            ...
            'amendment': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
