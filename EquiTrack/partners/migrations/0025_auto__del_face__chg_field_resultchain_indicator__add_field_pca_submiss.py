...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'partners_pca', 'submission_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PCA.partner_mng_phone'
        db.add_column(u'partners_pca', 'partner_mng_phone',
    ...
    def backwards(self, orm):
        # Adding model 'FACE'
        db.create_table(u'partners_face', (
            ('date_paid', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default=u'requested', max_length=100)),
            ('amount', self.gf('django.db.models.fields.CharField')(default=0, max_length=100)),
            ('submited_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('pca', self.gf('django.db.models.fields.related.ForeignKey')(related_name='face_refs', to=orm['partners.PCA'])),
            ('ref', self.gf('django.db.models.fields.CharField')(max_length=100)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'partners', ['FACE'])


        # User chose to not deal with backwards NULL issues for 'ResultChain.indicator'
        raise RuntimeError("Cannot reverse this migration. 'ResultChain.indicator' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ResultChain.indicator'
        db.alter_column(u'partners_resultchain', 'indicator_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['reports.Indicator']))
        # Deleting field 'PCA.submission_date'
        db.delete_column(u'partners_pca', 'submission_date')

        # Deleting field 'PCA.partner_mng_phone'
        db.delete_column(u'partners_pca', 'partner_mng_phone')
        ...
        # Changing field 'PCA.agreement'
        db.alter_column(u'partners_pca', 'agreement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partners.Agreement'], null=True))
        # Adding field 'Agreement.signed_by_unicef_rep'
        db.add_column(u'partners_agreement', 'signed_by_unicef_rep',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='signed_pcas', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Agreement.signed_by'
        db.delete_column(u'partners_agreement', 'signed_by_id')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#A10017'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#74D098'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#72A253'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.agreement': {
            ...
            'partner_email': ('django.db.models.fields.CharField', [], {'max_length': '128L', 'blank': 'True'}),
            'partner_first_name': ('django.db.models.fields.CharField', [], {'max_length': '64L', 'blank': 'True'}),
            'partner_last_name': ('django.db.models.fields.CharField', [], {'max_length': '64L', 'blank': 'True'}),
        ...
        u'partners.pca': {
            ...
            'partner_focal_email': ('django.db.models.fields.CharField', [], {'max_length': '128L', 'blank': 'True'}),
            'partner_focal_first_name': ('django.db.models.fields.CharField', [], {'max_length': '64L', 'blank': 'True'}),
            'partner_focal_last_name': ('django.db.models.fields.CharField', [], {'max_length': '64L', 'blank': 'True'}),
            'partner_focal_phone': ('django.db.models.fields.CharField', [], {'max_length': '64L', 'blank': 'True'}),
