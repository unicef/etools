...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpotCheck.sector'
        db.alter_column(u'partners_spotcheck', 'sector_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Sector'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SpotCheck.sector'
        raise RuntimeError("Cannot reverse this migration. 'SpotCheck.sector' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SpotCheck.sector'
        db.alter_column(u'partners_spotcheck', 'sector_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Sector']))
