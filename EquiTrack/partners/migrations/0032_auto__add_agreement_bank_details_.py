...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agreement.bank_name'
        db.add_column(u'partners_agreement', 'bank_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.bank_address'
        db.add_column(u'partners_agreement', 'bank_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256L, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.account_title'
        db.add_column(u'partners_agreement', 'account_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.account_number'
        db.add_column(u'partners_agreement', 'account_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.routing_details'
        db.add_column(u'partners_agreement', 'routing_details',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agreement.bank_contact_person'
        db.add_column(u'partners_agreement', 'bank_contact_person',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agreement.bank_name'
        db.delete_column(u'partners_agreement', 'bank_name')

        # Deleting field 'Agreement.bank_address'
        db.delete_column(u'partners_agreement', 'bank_address')

        # Deleting field 'Agreement.account_title'
        db.delete_column(u'partners_agreement', 'account_title')

        # Deleting field 'Agreement.account_number'
        db.delete_column(u'partners_agreement', 'account_number')

        # Deleting field 'Agreement.routing_details'
        db.delete_column(u'partners_agreement', 'routing_details')

        # Deleting field 'Agreement.bank_contact_person'
        db.delete_column(u'partners_agreement', 'bank_contact_person')
    ...
    models = {
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#1D8A10'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#C94649'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#726296'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'partners.agreement': {
            ...
            'account_number': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'account_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'bank_address': ('django.db.models.fields.CharField', [], {'max_length': '256L', 'blank': 'True'}),
            'bank_contact_person': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'bank_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'routing_details': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
