...
class PartnerOrganizationHactCsvRenderer(r.CSVRenderer):
    ...
    header = [
        ...
        'hact_values.programmatic_visits.minimum_requirements',
        ...
        'hact_values.spot_checks.minimum_requirements',
    ...
    labels = {
        ...
        'hact_values.programmatic_visits.minimum_requirements': 'Programmatic Visits M.R',
        ...
        'hact_values.spot_checks.minimum_requirements': 'Spot Checks M.R',
