...
class PartnerOrganizationHactCsvRenderer(r.CSVRenderer):
    ...
    header = [
        ...
        'hact_values.programmatic_visits.minumum_requirements',
        ...
        'hact_values.spot_checks.minumum_requirements',
        ...
        'hact_values.audits.minumum_requirements',
        'hact_values.audits.completed',
        'hact_values.audits.outstanding_findings',
    ]
    ...
    labels = {
        ...
        'hact_values.programmatic_visits.minumum_requirements': 'Programmatic Visits M.R',
        ...
        'hact_values.spot_checks.minumum_requirements': 'Spot Checks M.R',
        ...
        'hact_values.audits.minumum_requirements': 'Audits M.R',
        'hact_values.audits.completed': 'Audit Completed',
        'hact_values.audits.outstanding_findings': 'Audits Outstanding Findings',
    }
