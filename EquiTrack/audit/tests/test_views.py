...
class TestMARisksViewSet(BaseTestCategoryRisksViewSet, TenantTestCase):
...
class TestAuditRisksViewSet(BaseTestCategoryRisksViewSet, TenantTestCase):
...
class TestEngagementsListViewSet(EngagementTransitionsTestCaseMixin, TenantTestCase):
    engagement_factory = MicroAssessmentFactory
...
class TestEngagementsCreateViewSet(EngagementTransitionsTestCaseMixin, TenantTestCase):
    engagement_factory = MicroAssessmentFactory
...
class TestEngagementsUpdateViewSet(EngagementTransitionsTestCaseMixin, TenantTestCase):
    engagement_factory = MicroAssessmentFactory
...
class TestAuditorFirmViewSet(AuditTestCaseMixin, TenantTestCase):
    def setUp(self):
...
class TestAuditorStaffMembersViewSet(AuditTestCaseMixin, TenantTestCase):
...
class TestEngagementPDFExportViewSet(EngagementTransitionsTestCaseMixin, TenantTestCase):
    engagement_factory = AuditFactory
...
class TestPurchaseOrderView(AuditTestCaseMixin, TenantTestCase):
    def setUp(self):
...
class TestEngagementPartnerView(AuditTestCaseMixin, TenantTestCase):
    def test_get(self):
