...
from funds.models import FundsReservationItem, FundsReservationHeader, FundsCommitmentHeader, FundsCommitmentItem


class TestFundsReservationItem(FastTenantTestCase):

    def setUp(self):
        self.fr_header = FundsReservationHeader.objects.create(fr_number='23')
...
class TestFundsCommitmentItem(FastTenantTestCase):
    ...
    def setUp(self):
        self.fc_header = FundsCommitmentHeader.objects.create(fc_number='23')
