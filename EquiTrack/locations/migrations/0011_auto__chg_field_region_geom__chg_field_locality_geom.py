...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'locations_region', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Locality.geom'
        db.alter_column(u'locations_locality', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

    def backwards(self, orm):

        # Changing field 'Region.geom'
        db.alter_column(u'locations_region', 'geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'Locality.geom'
        db.alter_column(u'locations_locality', 'geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
