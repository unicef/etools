...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CartoDBTable.display_name'
        db.add_column(u'locations_cartodbtable', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CartoDBTable.color'
        db.add_column(u'locations_cartodbtable', 'color',
                      self.gf('paintstore.fields.ColorPickerField')(default='#23643E', max_length=7, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'CartoDBTable.display_name'
        db.delete_column(u'locations_cartodbtable', 'display_name')

        # Deleting field 'CartoDBTable.color'
        db.delete_column(u'locations_cartodbtable', 'color')
    ...
    models = {
        ...
        u'locations.cartodbtable': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#3926DE'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.governorate': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#35C690'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
        ...
        u'locations.locality': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#DCC5F6'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'locations.region': {
            ...
            'color': ('paintstore.fields.ColorPickerField', [], {'default': "'#A41343'", 'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.GatewayType']", 'null': 'True', 'blank': 'True'}),
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
            'governorate': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.Governorate']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
