...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Locality', fields ['cas_code_un', 'name']
        db.create_unique(u'locations_locality', ['cas_code_un', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Locality', fields ['cas_code_un', 'name']
        db.delete_unique(u'locations_locality', ['cas_code_un', 'name'])
