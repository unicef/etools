...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Governorate.area'
        db.alter_column(u'locations_governorate', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'Locality.area'
        db.alter_column(u'locations_locality', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'Region.area'
        db.alter_column(u'locations_region', 'area', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

    def backwards(self, orm):

        # Changing field 'Governorate.area'
        db.alter_column(u'locations_governorate', 'area', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))

        # Changing field 'Locality.area'
        db.alter_column(u'locations_locality', 'area', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))

        # Changing field 'Region.area'
        db.alter_column(u'locations_region', 'area', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))
