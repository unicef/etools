...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartoDBTable.longitude_col'
        db.delete_column(u'locations_cartodbtable', 'longitude_col')

        # Deleting field 'CartoDBTable.latitude_col'
        db.delete_column(u'locations_cartodbtable', 'latitude_col')


    def backwards(self, orm):
        # Adding field 'CartoDBTable.longitude_col'
        db.add_column(u'locations_cartodbtable', 'longitude_col',
                      self.gf('django.db.models.fields.CharField')(default='longitude', max_length=254),
                      keep_default=False)

        # Adding field 'CartoDBTable.latitude_col'
        db.add_column(u'locations_cartodbtable', 'latitude_col',
                      self.gf('django.db.models.fields.CharField')(default='latitude', max_length=254),
                      keep_default=False)
