...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkedLocation.location'
        db.alter_column(u'locations_linkedlocation', 'location_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['locations.Location'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LinkedLocation.location'
        raise RuntimeError("Cannot reverse this migration. 'LinkedLocation.location' and its values cannot be restored.")
