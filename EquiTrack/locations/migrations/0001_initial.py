...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cad_code', models.CharField(max_length=11)),
                ('cas_code', models.CharField(max_length=11)),
                ('cas_code_un', models.CharField(max_length=11)),
                ('name', models.CharField(max_length=128)),
                ('cas_village_name', models.CharField(max_length=128)),
                ('p_code', models.CharField(blank=True, max_length=32, null=True)),
                ('color', models.CharField(blank=True, default=locations.models.get_random_color, max_length=7, null=True)),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(blank=True, null=True, srid=4326)),
                ('gateway', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='locations.GatewayType', verbose_name='Admin type')),
