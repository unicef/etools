...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.gateway'
        db.add_column(u'locations_location', 'gateway',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['locations.GatewayType']),
                      keep_default=False)


        # Changing field 'Location.locality'
        db.alter_column(u'locations_location', 'locality_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['locations.Locality']))

    def backwards(self, orm):
        # Deleting field 'Location.gateway'
        db.delete_column(u'locations_location', 'gateway_id')


        # Changing field 'Location.locality'
        db.alter_column(u'locations_location', 'locality_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Locality'], null=True))
