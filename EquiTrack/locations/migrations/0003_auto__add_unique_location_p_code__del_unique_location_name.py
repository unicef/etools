...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Location', fields ['p_code']
        db.create_unique(u'locations_location', ['p_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['p_code']
        db.delete_unique(u'locations_location', ['p_code'])
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'p_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32L', 'blank': 'True'}),
