...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'locations_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Location.point'
        raise RuntimeError("Cannot reverse this migration. 'Location.point' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Location.point'
        db.alter_column(u'locations_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')())
