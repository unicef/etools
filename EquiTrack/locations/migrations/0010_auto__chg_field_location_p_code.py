...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.p_code'
        db.alter_column(u'locations_location', 'p_code', self.gf('django.db.models.fields.CharField')(max_length=32L, null=True))

    def backwards(self, orm):

        # Changing field 'Location.p_code'
        db.alter_column(u'locations_location', 'p_code', self.gf('django.db.models.fields.CharField')(default='', max_length=32L))
