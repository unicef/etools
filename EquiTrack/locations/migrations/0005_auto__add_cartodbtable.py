...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CartoDBTable'
        db.create_table(u'locations_cartodbtable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('table_name', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('location_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.GatewayType'])),
            ('name_col', self.gf('django.db.models.fields.CharField')(default='name', max_length=254)),
            ('pcode_col', self.gf('django.db.models.fields.CharField')(default='pcode', max_length=254)),
            ('latitude_col', self.gf('django.db.models.fields.CharField')(default='latitude', max_length=254)),
            ('longitude_col', self.gf('django.db.models.fields.CharField')(default='longitude', max_length=254)),
        ))
        db.send_create_signal(u'locations', ['CartoDBTable'])


    def backwards(self, orm):
        # Deleting model 'CartoDBTable'
        db.delete_table(u'locations_cartodbtable')
