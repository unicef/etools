...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'locations_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=254L))

    def backwards(self, orm):

        # Changing field 'Location.name'
        db.alter_column(u'locations_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=45L))
