...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartoDBTable.domain'
        db.add_column(u'locations_cartodbtable', 'domain',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254),
                      keep_default=False)

        # Adding field 'CartoDBTable.api_key'
        db.add_column(u'locations_cartodbtable', 'api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartoDBTable.domain'
        db.delete_column(u'locations_cartodbtable', 'domain')

        # Deleting field 'CartoDBTable.api_key'
        db.delete_column(u'locations_cartodbtable', 'api_key')
