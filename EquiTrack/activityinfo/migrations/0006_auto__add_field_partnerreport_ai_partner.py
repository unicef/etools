...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerReport.ai_partner'
        db.add_column(u'activityinfo_partnerreport', 'ai_partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['activityinfo.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerReport.ai_partner'
        db.delete_column(u'activityinfo_partnerreport', 'ai_partner_id')
