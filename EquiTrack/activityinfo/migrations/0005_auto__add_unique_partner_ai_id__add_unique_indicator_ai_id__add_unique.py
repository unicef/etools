...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Partner', fields ['ai_id']
        db.create_unique(u'activityinfo_partner', ['ai_id'])

        # Adding unique constraint on 'Indicator', fields ['ai_id']
        db.create_unique(u'activityinfo_indicator', ['ai_id'])

        # Adding unique constraint on 'Database', fields ['ai_id']
        db.create_unique(u'activityinfo_database', ['ai_id'])

        # Adding unique constraint on 'Activity', fields ['ai_id']
        db.create_unique(u'activityinfo_activity', ['ai_id'])

        # Adding unique constraint on 'AttributeGroup', fields ['ai_id']
        db.create_unique(u'activityinfo_attributegroup', ['ai_id'])

        # Adding unique constraint on 'Attribute', fields ['ai_id']
        db.create_unique(u'activityinfo_attribute', ['ai_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Attribute', fields ['ai_id']
        db.delete_unique(u'activityinfo_attribute', ['ai_id'])

        # Removing unique constraint on 'AttributeGroup', fields ['ai_id']
        db.delete_unique(u'activityinfo_attributegroup', ['ai_id'])

        # Removing unique constraint on 'Activity', fields ['ai_id']
        db.delete_unique(u'activityinfo_activity', ['ai_id'])

        # Removing unique constraint on 'Database', fields ['ai_id']
        db.delete_unique(u'activityinfo_database', ['ai_id'])

        # Removing unique constraint on 'Indicator', fields ['ai_id']
        db.delete_unique(u'activityinfo_indicator', ['ai_id'])

        # Removing unique constraint on 'Partner', fields ['ai_id']
        db.delete_unique(u'activityinfo_partner', ['ai_id'])
