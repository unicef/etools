...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerReport.month'
        db.add_column(u'activityinfo_partnerreport', 'month',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerReport.month'
        db.delete_column(u'activityinfo_partnerreport', 'month')
