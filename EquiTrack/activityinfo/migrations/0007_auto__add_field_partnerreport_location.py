...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerReport.location'
        db.add_column(u'activityinfo_partnerreport', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerReport.location'
        db.delete_column(u'activityinfo_partnerreport', 'location')
