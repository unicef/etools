...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'TPMVisit.report' to match new field type.
        db.rename_column(u'tpm_tpmvisit', 'report_id', 'report')
        # Changing field 'TPMVisit.report'
        db.alter_column(u'tpm_tpmvisit', 'report', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
        # Removing index on 'TPMVisit', fields ['report']
        db.delete_index(u'tpm_tpmvisit', ['report_id'])


    def backwards(self, orm):
        # Adding index on 'TPMVisit', fields ['report']
        db.create_index(u'tpm_tpmvisit', ['report_id'])


        # Renaming column for 'TPMVisit.report' to match new field type.
        db.rename_column(u'tpm_tpmvisit', 'report', 'report_id')
        # Changing field 'TPMVisit.report'
        db.alter_column(u'tpm_tpmvisit', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))
    ...
    models = {
        ...
        u'tpm.tpmvisit': {
            ...
            'assigned_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'completed_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'cycle_number': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
