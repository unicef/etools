...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TPMVisit.created_date'
        db.add_column(u'tpm_tpmvisit', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TPMVisit.created_date'
        db.delete_column(u'tpm_tpmvisit', 'created_date')
