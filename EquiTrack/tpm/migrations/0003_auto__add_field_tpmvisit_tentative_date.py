...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TPMVisit.tentative_date'
        db.add_column(u'tpm_tpmvisit', 'tentative_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TPMVisit.tentative_date'
        db.delete_column(u'tpm_tpmvisit', 'tentative_date')
