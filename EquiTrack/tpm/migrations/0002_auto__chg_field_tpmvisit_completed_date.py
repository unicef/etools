...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TPMVisit.completed_date'
        db.alter_column(u'tpm_tpmvisit', 'completed_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TPMVisit.completed_date'
        raise RuntimeError("Cannot reverse this migration. 'TPMVisit.completed_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TPMVisit.completed_date'
        db.alter_column(u'tpm_tpmvisit', 'completed_date', self.gf('django.db.models.fields.DateField')())
