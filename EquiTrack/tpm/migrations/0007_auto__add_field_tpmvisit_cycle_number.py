...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TPMVisit.cycle_number'
        db.add_column(u'tpm_tpmvisit', 'cycle_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TPMVisit.cycle_number'
        db.delete_column(u'tpm_tpmvisit', 'cycle_number')
