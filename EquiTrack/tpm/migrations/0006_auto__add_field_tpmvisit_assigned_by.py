...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TPMVisit.assigned_by'
        db.add_column(u'tpm_tpmvisit', 'assigned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TPMVisit.assigned_by'
        db.delete_column(u'tpm_tpmvisit', 'assigned_by_id')
