...
class TestActivePCANoSignedDocCheck(TenantTestCase):
    def setUp(self):
...
class TestPdOutputsWrongCheck(TenantTestCase):
    def setUp(self):
...
class TestInterventionsAssociatedSSFACheck(TenantTestCase):
    def setUp(self):
...
class TestInterventionsAreValidCheck(TenantTestCase):
    def setUp(self):
...
class TestPDAmendmentsMissingFilesCheck(TenantTestCase):
    def setUp(self):
...
class TestPCAAmendmentsMissingFilesCheck(TenantTestCase):
    def setUp(self):
