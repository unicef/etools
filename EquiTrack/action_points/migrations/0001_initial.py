    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('engagement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='audit.Engagement', verbose_name='Engagement')),
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.Sector', verbose_name='Section')),
                ('tpm_activity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tpm.TPMActivity', verbose_name='TPM Activity')),
                ('travel_activity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='t2f.TravelActivity', verbose_name='Travel Activity')),
            ],
            options={
                'abstract': False,
            },
