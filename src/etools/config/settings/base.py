...
FAM_FACE_FORMS_RELEASE_DATE = get_from_secrets_or_env('FAM_FACE_FORMS_RELEASE_DATE', '2025-08-21')
FAM_FACE_FORMS_RELEASE_DATE = datetime.datetime.strptime(FAM_FACE_FORMS_RELEASE_DATE, '%Y-%m-%d').date()
