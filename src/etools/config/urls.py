...
from etools.applications.email_auth.urls import urlpatterns as email_auth_patterns
...
urlpatterns = [
    ...
    url(r'^api/tpm/', include('etools.applications.tpm.urls', namespace='tpm')),
    url(r'^api/audit/', include('etools.applications.audit.urls', namespace='audit')),
    ...
    url(r'^api/v2/hact/', include('etools.applications.hact.urls', namespace='hact_api')),
    ...
    url(r'^api/v2/funds/', include('etools.applications.funds.urls', namespace='funds')),
    url(
        r'^api/v2/activity/',
        include('etools.applications.snapshot.urls', namespace='snapshot_api')
    ),
    url(r'^api/v2/environment/', include('etools.applications.environment.urls_v2', namespace='environment')),
    url(
        r'^api/v2/attachments/',
        include('etools.applications.attachments.urls', namespace='attachments')
    ),
