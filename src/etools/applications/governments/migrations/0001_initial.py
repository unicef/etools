# Generated by Django 4.2.3 on 2025-02-21 10:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wpa_id', models.CharField(blank=True, max_length=500, null=True, verbose_name='Workplan Activity ID')),
                ('wbs', models.CharField(blank=True, max_length=500, null=True, verbose_name='Workplan Activity WBS')),
                ('title', models.CharField(blank=True, max_length=500, null=True, verbose_name='WPA Title')),
                ...
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Activity Start Date')),
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Activity End Date')),
                ('other', models.JSONField(blank=True, null=True, verbose_name='Other')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_fsm.FSMField(blank=True, choices=[('draft', 'Development'), ('review', 'Review'), ('pending_approval', 'Pending Approval'), ('approved', 'Approved'), ('active', 'Active'), ('cancelled', 'Cancelled'), ('ended', 'Ended'), ('closed', 'Closed'), ('suspended', 'Suspended'), ('terminated', 'Terminated'), ('expired', 'Expired')], default='draft', max_length=32, verbose_name='Status')),
                ...
                ('submission_date', models.DateField(blank=True, help_text='The date the partner submitted complete GDD documents to Unicef', null=True, verbose_name='Document Submission Date by Government')),
                ...
                ('cash_transfer_modalities', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('payment', 'Direct Payment'), ('reimbursement', 'Reimbursement'), ('dct', 'Direct Cash Transfer')], max_length=50, verbose_name='Cash Transfer Modalities'), blank=True, default=list, size=None)),
                ...
                ('signature_required', models.BooleanField(default=False, verbose_name='Signature Required')),
                ...
                ('country_programme', models.ForeignKey(blank=True, help_text='Which Country Programme does this GDD belong to?', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='government_gdds', to='reports.countryprogramme', verbose_name='Country Programmes')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cso_cash', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='Government Cash')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('ewp_activity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gdd_activities', to='governments.ewpactivity', verbose_name='eWP Activity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code')),
                ('cp_output', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='result_links', to='governments.ewpoutput', verbose_name='CP Output')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_comparative_advantage', models.CharField(blank=True, choices=[('', 'Not decided yet'), ('a', 'Yes, strongly agree'), ('b', 'Yes, agree'), ('c', 'No, disagree'), ('d', 'No, strongly disagree')], max_length=100, verbose_name='The partner selection evidences the Government’s comparative advantage and value for money in relation to the planned results')),
                ('relationships_are_positive', models.CharField(blank=True, choices=[('', 'Not decided yet'), ('a', 'Yes, strongly agree'), ('b', 'Yes, agree'), ('c', 'No, disagree'), ('d', 'No, strongly disagree')], max_length=100, verbose_name='Previous UNICEF/UN relationships with the proposed Government have been positive')),
                ...
                ('pd_is_guided', models.CharField(blank=True, choices=[('', 'Not decided yet'), ('a', 'Yes, strongly agree'), ('b', 'Yes, agree'), ('c', 'No, disagree'), ('d', 'No, strongly disagree')], max_length=100, verbose_name='The results framework of the proposed GDD has been guided by M&E feedback during the drafting process')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('name', models.CharField(blank=True, max_length=500, null=True, verbose_name='Workplan Name')),
                ('ewp_id', models.CharField(blank=True, max_length=500, null=True, verbose_name='Workplan ID')),
                ('wbs', models.CharField(blank=True, max_length=500, null=True, verbose_name='Workplan WBS')),
                ('status', models.CharField(blank=True, max_length=50, null=True, verbose_name='Status')),
                ('cost_center_code', models.CharField(blank=True, max_length=500, null=True, verbose_name='Cost Center Code')),
                ('cost_center_name', models.CharField(blank=True, max_length=500, null=True, verbose_name='Cost Center Name')),
                ('plan_type', models.CharField(blank=True, max_length=50, null=True, verbose_name='Plan Type')),
                ('category_type', models.CharField(blank=True, max_length=50, null=True, verbose_name='Plan Category Type')),
                ...
                ('other', models.JSONField(blank=True, null=True, verbose_name='Other')),
                ('country_programme', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='workplans', to='reports.countryprogramme')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='governments.gddresultlink', verbose_name='Result')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('risk_type', models.CharField(choices=[('safeguarding', 'Safeguarding'), ('environment', 'Social and Environmental'), ('financial', 'Financial'), ('operational', 'Operational'), ('political', 'Political'), ('security', 'Safety and security')], max_length=50, verbose_name='Risk Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overall_approval', models.BooleanField(blank=True, null=True)),
                ('review_date', models.DateField(blank=True, null=True, verbose_name='Review Date')),
                ('overall_review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gdd_prc_reviews', to='governments.gddreview')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gdd_prc_reviews', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code')),
                ('ewp_key_intervention', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gdd_key_interventions', to='governments.ewpkeyintervention', verbose_name='CP Key Intervention')),
                ('result_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gdd_key_interventions', to='governments.gddresultlink', verbose_name='Result Link')),
            ],
            options={
                'ordering': ('created',),
        ...
        migrations.AddField(
            model_name='gdd',
            name='flat_locations',
            field=models.ManyToManyField(blank=True, related_name='gdds_flat_locations', to='locations.location', verbose_name='Locations'),
        ),
        migrations.AddField(
            model_name='gdd',
            name='lead_section',
        ...
        migrations.AddField(
            model_name='gdd',
            name='offices',
            field=models.ManyToManyField(blank=True, related_name='office_gdds', to='reports.office', verbose_name='Office'),
        ),
        migrations.AddField(
            model_name='gdd',
            name='partner',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='government_gdds', to='partners.partnerorganization', verbose_name='Government'),
        ),
        migrations.AddField(
            model_name='gdd',
            name='partner_authorized_officer_signatory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signed_gdds', to=settings.AUTH_USER_MODEL, verbose_name='Signed by Partner'),
        ),
        migrations.AddField(
            model_name='gdd',
        ...
        migrations.AddField(
            model_name='gdd',
            name='sites',
            field=models.ManyToManyField(blank=True, related_name='gdds', to='field_monitoring_settings.locationsite', verbose_name='Sites'),
        ),
        migrations.AddField(
            model_name='gdd',
            name='unicef_focal_points',
            field=models.ManyToManyField(blank=True, related_name='unicef_gdds_focal_points+', to=settings.AUTH_USER_MODEL, verbose_name='UNICEF Focal Points'),
        ),
        migrations.AddField(
            model_name='gdd',
            name='unicef_signatory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signed_gdds+', to=settings.AUTH_USER_MODEL, verbose_name='Signed by UNICEF'),
        ),
        migrations.AddField(
            model_name='ewpoutput',
            name='workplan',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ewp_outputs', to='governments.governmentewp', verbose_name='Workplan'),
        ),
        migrations.AddField(
            model_name='ewpkeyintervention',
            name='ewp_output',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ewp_key_interventions', to='governments.ewpoutput'),
        ),
        migrations.AddField(
            model_name='ewpactivity',
            name='ewp_key_intervention',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ewp_activity_for_ki', to='governments.ewpkeyintervention'),
        ),
        migrations.AddField(
            model_name='ewpactivity',
            name='locations',
