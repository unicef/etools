    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ewp_activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gov_intervention_activities', to='governments.ewpactivity', verbose_name='EWP Activity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amendment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='governments.governmentamendment', verbose_name='Amendment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='government_interventions', to='partners.agreement', verbose_name='Agreement')),
                ...
                ('country_programmes', models.ManyToManyField(blank=True, help_text='Which Country Programme does this Intervention belong to?', related_name='government_interventions', to='reports.countryprogramme', verbose_name='Country Programmes')),
                ('flat_locations', models.ManyToManyField(blank=True, related_name='gov_intervention_flat_locations', to='locations.location', verbose_name='Locations')),
                ('offices', models.ManyToManyField(blank=True, related_name='office_gov_interventions', to='reports.office', verbose_name='Office')),
                ('partner_authorized_officer_signatory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signed_gov_interventions', to=settings.AUTH_USER_MODEL, verbose_name='Signed by Partner')),
                ('partner_focal_points', models.ManyToManyField(blank=True, related_name='gov_interventions_focal_points+', to=settings.AUTH_USER_MODEL, verbose_name='CSO Authorized Officials')),
                ('partner_organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='government_interventions', to='partners.partnerorganization', verbose_name='Government')),
                ('sections', models.ManyToManyField(blank=True, related_name='gov_interventions', to='reports.section', verbose_name='Sections')),
                ('sites', models.ManyToManyField(blank=True, related_name='gov_interventions', to='field_monitoring_settings.locationsite', verbose_name='Sites')),
                ('unicef_focal_points', models.ManyToManyField(blank=True, related_name='unicef_gov_interventions_focal_points+', to=settings.AUTH_USER_MODEL, verbose_name='UNICEF Focal Points')),
                ('unicef_signatory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='signed_gov_interventions+', to=settings.AUTH_USER_MODEL, verbose_name='Signed by UNICEF')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quarters', to='governments.govintervention', verbose_name='Government Intervention')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='supply_items', to='governments.govintervention', verbose_name='Government Intervention')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='risks', to='governments.govintervention', verbose_name='Government Intervention')),
            ],
            options={
                'ordering': ('id',),
            },
        ...
        migrations.CreateModel(
            name='GovernmentReviewNotification',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gov_prc_notifications', to='governments.governmentreview')),
        ...
        migrations.AddField(
            model_name='governmentreview',
            name='intervention',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='governments.govintervention', verbose_name='Government Intervention'),
        ),
        migrations.AddField(
            model_name='governmentreview',
        ...
        migrations.CreateModel(
            name='GovernmentResultLink',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code')),
                ('cp_output', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gov_intervention_links', to='reports.result', verbose_name='CP Output')),
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='result_links', to='governments.govintervention', verbose_name='Intervention')),
        ...
        migrations.CreateModel(
            name='GovernmentReportingPeriod',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ...
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reporting_periods', to='governments.govintervention', verbose_name='Government Intervention')),
            ],
            options={
                'ordering': ['-due_date'],
            },
        ...
        migrations.CreateModel(
            name='GovernmentPRCOfficerReview',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ...
                ('overall_approval', models.BooleanField(blank=True, null=True)),
                ('review_date', models.DateField(blank=True, null=True, verbose_name='Review Date')),
                ('overall_review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gov_prc_reviews', to='governments.governmentreview')),
        ...
        migrations.CreateModel(
            name='GovernmentPlannedVisitSite',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quarter', models.PositiveSmallIntegerField(choices=[(1, 'Q1'), (2, 'Q2'), (3, 'Q3'), (4, 'Q4')])),
                ('planned_visits', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='governments.governmentplannedvisits')),
        ...
        migrations.AddField(
            model_name='governmentplannedvisits',
            name='intervention',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='planned_visits', to='governments.govintervention', verbose_name='Government Intervention'),
        ),
        migrations.AddField(
            model_name='governmentplannedvisits',
            name='sites',
            field=models.ManyToManyField(blank=True, through='governments.GovernmentPlannedVisitSite', to='field_monitoring_settings.locationsite', verbose_name='Sites'),
        ),
        migrations.CreateModel(
            name='GovernmentEWP',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intervention', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='planned_budget', to='governments.govintervention', verbose_name='Intervention')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='GovernmentAttachment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('active', models.BooleanField(default=True)),
                ('intervention', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='governments.govintervention', verbose_name='Intervention')),
        ...
        migrations.AddField(
            model_name='governmentamendment',
            name='amended_intervention',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='amendment', to='governments.govintervention', verbose_name='Amended Intervention'),
        ),
        migrations.AddField(
            model_name='governmentamendment',
            name='intervention',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='amendments', to='governments.govintervention', verbose_name='Reference Number'),
        ),
        migrations.AddField(
            model_name='governmentamendment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unicef_cash', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='UNICEF Cash')),
                ('cso_cash', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='CSO Cash')),
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='governments.governmentactivity', verbose_name='Government Intervention Activity')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='governmentactivity',
            name='time_frames',
            field=models.ManyToManyField(blank=True, related_name='activities', to='governments.governmenttimeframe', verbose_name='Time Frames Enabled'),
        ),
        migrations.CreateModel(
            name='EWPResultLink',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code')),
                ('result_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ll_results', to='governments.governmentresultlink', verbose_name='Result Link')),
            ],
            options={
                'ordering': ('created',),
