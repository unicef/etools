    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='reports.office', verbose_name='Office')),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='reports.section', verbose_name='Section')),
                ...
                ('traveler', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='travels', to=settings.AUTH_USER_MODEL, verbose_name='Traveller')),
            ],
        ),
        migrations.CreateModel(
            name='T2FActionPoint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airlines', models.ManyToManyField(related_name='_t2f_itineraryitem_airlines_+', to='publics.AirlineCompany', verbose_name='Airlines')),
                ...
                ('travel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itinerary', to='t2f.travel', verbose_name='Travel')),
            ],
            options={
