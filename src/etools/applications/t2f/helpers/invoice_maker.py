...
from etools.applications.publics.models import Fund, Grant, TravelExpenseType, WBS
...
class InvoiceMaker(object):
    ...
    def do_invoicing(self):
        ...
        self.travel = self.travel.__class__.objects.select_for_update().get(id=self.travel.id)
    ...
    def make_invoices(self, vendor_grouping):
        ...
        from etools.applications.t2f.models import Invoice, InvoiceItem
