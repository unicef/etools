...
class TravelMailSerializer(serializers.Serializer):
    ...
    start_date = serializers.DateTimeField(format='%m/%d/%Y', source='start_datetime')
    end_date = serializers.DateTimeField(format='%m/%d/%Y', source='end_datetime')
...
class ActionPointMailSerializer(serializers.Serializer):
    ...
    due_date = serializers.DateTimeField(format='%m/%d/%Y', source='due_datetime')
