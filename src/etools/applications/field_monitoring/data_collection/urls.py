...
from etools.applications.field_monitoring.data_collection.views import VisitsDataCollectionViewSet, \
    ...
    TaskDataCheckListViewSet, TaskDataCheckListAttachmentsViewSet, TasksOverallCheckListAttachmentsViewSet
...
started_methods_api.register(r'tasks-data/checklist', TaskDataCheckListViewSet, base_name='task-data-checklist')
started_methods_api.register(r'tasks-data/(?P<task_data_id>[0-9]+)/checklist/(?P<checklist_item_id>[0-9]+)/attachments',
                             TaskDataCheckListAttachmentsViewSet, base_name='task-data-checklist')
