...
from etools.applications.attachments import serializers_fields as fields
...
class TestModelChoiceFileField(BaseTenantTestCase):
    def setUp(self):
        self.code1_obj = AttachmentFileTypeFactory(code='code1')
        self.code2_obj = AttachmentFileTypeFactory(code='code2')
