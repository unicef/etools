...
from etools.applications.utils.common.tests.models import Child1, Parent
...
class SeparateReadWriteTestCase(TestCase):
    ...
    def test_serializers_tree(self):
        ...
        self.assertEqual(serializer.fields['parent'].write_field.source_attrs,
                         serializer.fields['parent'].source_attrs)
