...
class Audit(Engagement):
    ...
    financial_findings = models.DecimalField(verbose_name=_('Financial Findings $'), blank=True, default=0,
                                             decimal_places=2, max_digits=20)
    # local currency
    audited_expenditure_local = models.DecimalField(verbose_name=_('Audited Expenditure $'), blank=True, null=True,
                                                    decimal_places=2, max_digits=20)
    financial_findings_local = models.DecimalField(verbose_name=_('Financial Findings $'), blank=True, null=True,
                                                   decimal_places=2, max_digits=20)
