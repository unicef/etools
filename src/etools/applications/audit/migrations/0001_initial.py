    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Start date of first reporting FACE')),
                ('end_date', models.DateField(blank=True, null=True, verbose_name='End date of last reporting FACE')),
                ...
                ('send_back_comment', models.TextField(blank=True, verbose_name='Send Back Comment')),
