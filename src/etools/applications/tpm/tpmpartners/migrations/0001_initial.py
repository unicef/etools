        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_tpm_notifications', models.BooleanField(
                    default=False, verbose_name='Receive Notifications on TPM Tasks')),
                ('tpm_partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='staff_members', to='tpmpartners.TPMPartner', verbose_name='TPM Vendor')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                                              related_name='tpmpartners_tpmpartnerstaffmember', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'abstract': False,
                'ordering': ('id',),
