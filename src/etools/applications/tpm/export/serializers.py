...
class TPMActivityExportSerializer(serializers.Serializer):
    ...
    intervention = serializers.CharField(source='intervention.reference_number', default='')
...
class TPMLocationExportSerializer(serializers.Serializer):
    ...
    intervention = serializers.CharField(source='activity.tpmactivity.intervention.reference_number', default='')
    pd_ssfa = serializers.CharField(source='activity.tpmactivity.intervention.title', default='')
