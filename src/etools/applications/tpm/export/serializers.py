...
class TPMPartnerContactsSerializer(serializers.Serializer):
    ...
    job_title = serializers.CharField(source='profile.job_title', allow_null=True)
    phone_number = serializers.CharField(source='profile.phone_number', allow_null=True)
    org_id = serializers.CharField(source='profile.organization.vendor_number', allow_null=True)
    org_name = serializers.CharField(source='profile.organization.name', allow_null=True)
    org_email = serializers.CharField(source='profile.organization.tpmpartner.email', allow_null=True)
    org_phone = serializers.CharField(source='profile.organization.tpmpartner.phone_number', allow_null=True)
    org_country = serializers.CharField(source='profile.organization.tpmpartner.country', allow_null=True)
    org_city = serializers.CharField(source='profile.organization.tpmpartner.city', allow_null=True)
    org_address = serializers.CharField(source='profile.organization.tpmpartner.street_address', allow_null=True)
    org_postal_code = serializers.CharField(source='profile.organization.tpmpartner.postal_code', allow_null=True)
