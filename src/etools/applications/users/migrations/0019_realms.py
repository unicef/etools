# Generated by Django 3.2.6 on 2022-08-09 08:53
    ...
    with transaction.atomic():
        ...
        for user in User.objects.all() \
            ...
            if not all_user_countries:
                no_countries += 1
                # logging.error(f"User {user.pk} has no country set. Skipping..")
                continue
            ...
            for country in realm_countries:
                ...
                is_in_unicef = groups.filter(name__contains='UNICEF').count() > 0 or 'unicef' in user.email
                if not groups:
                    if is_in_unicef:
                        realm = Realm(
                            user=user,
                    ...
                    if is_in_unicef:
                        ...
                        try:
                            partner_staff = PartnerStaffMember.objects \
                                .select_related('partner', 'partner__organization') \
...
def reverse_migrate_to_user_realms(apps, schema_editor):
    pass
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(fwd_migrate_to_user_realms, reverse_migrate_to_user_realms)
    ]
