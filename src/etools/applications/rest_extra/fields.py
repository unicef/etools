...
from etools.applications.rest_extra.serializers import WritableListSerializer
from etools.applications.rest_extra.utils import get_attribute_smart
...
class SeparatedReadWriteField(Field):
    ...
    def __init__(self, read_field, write_field=BuiltinField, *args, **kwargs):
        ...
        for kwarg_name in {'label', } & set(kwargs.keys()):
            ...
            if self.write_field is not BuiltinField:
