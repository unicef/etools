...
from etools.applications.permissions.serializers import PermissionsBasedSerializerMixin
from etools.applications.permissions.tests.models import Child2, Parent, Permission
