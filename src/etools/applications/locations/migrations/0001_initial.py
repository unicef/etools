# Generated by Django 3.2.6 on 2022-02-24 00:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_level_name',
                 models.CharField(blank=True, max_length=64, null=True, verbose_name='Admin Level Name')),
                ...
                ('parent',
                 mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                            related_name='children', to='locations.location',
                                            verbose_name='Parent')),
            ],
            options={
                'ordering': ['name'],
