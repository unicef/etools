    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_less_than_3_Months_usd', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='Amount mess than 3 months (USD)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('FACE', 'FACE'), ('Progress Report', 'Progress Report'), ('Final Partnership Review', 'Final Partnership Review'), ('Correspondence', 'Correspondence'), ('Supply/Distribution Plan', 'Supply/Distribution Plan'), ('Other', 'Other')], max_length=64, unique=True, verbose_name='Name')),
            ],
        ),
        migrations.CreateModel(
            name='Intervention',
            fields=[
                ...
                ('confidential', models.TextField(blank=True, null=True, verbose_name='Confidential')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_units', models.DecimalField(decimal_places=1, max_digits=20, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Units Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('highest_risk_rating_name', models.CharField(blank=True, choices=[('High', 'High'), ('Significant', 'Significant'), ('Medium', 'Medium'), ('Low', 'Low'), ('Not Required', 'Not Required'), ('High Risk Assumed', 'High Risk Assumed'), ('Low Risk Assumed', 'Low Risk Assumed'), ('Not Assessed', 'Not Assessed')], default='', max_length=150, verbose_name='Highest Risk Rating Name')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, default='', max_length=64, null=True, verbose_name='Phone Number')),
