...
from etools.applications.partners.views.partner_organization_v2 import (
    ...
    PartnerOrganizationHactFullAPIView,
...
urlpatterns = (
    ...
    url(r'^partners/hact/$',
        ...
        name='partner-hact'),
    url(r'^partners/hact/full/$',
        view=PartnerOrganizationHactFullAPIView.as_view(http_method_names=['get', ]),
        name='partner-hact-full'),
