...
class APIActionsMixin:
    """
    add viewsets-like action attribute to generic api views
    to reuse action-based things, for example permissions
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        # if api view is inherited from one of GenericAPIView subclasses,
        # we can just check which methods are defined
