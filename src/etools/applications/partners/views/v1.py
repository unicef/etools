...
# TODO replace PCA templates when provided
class GTCPDFView(LoginRequiredMixin, PDFTemplateView):
    agreement = None
    template_name = "gtc/english_pdf.html"
    # TODO add proper templates for different languages
    language_templates_mapping = {
        "arabic": "gtc/arabic_pdf.html",
        "english": "gtc/english_pdf.html",
        "french": "gtc/french_pdf.html",
        "portuguese": "gtc/portuguese_pdf.html",
        "russian": "gtc/russian_pdf.html",
        "spanish": "gtc/spanish_pdf.html",
        "ifrc_english": "gtc/ifrc_english_pdf.html",
        "ifrc_french": "gtc/ifrc_french_pdf.html"
    }
