...
defaults = {
    ...
    You are the focal point for Programme Document / SSFA {{ reference_number }} {{ title }}. The document has been in a draft status for some time now. If the document was signed, please complete the appropriate fields in eTools to move the document to status signed.
