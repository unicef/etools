...
router.register(r'users', UserViewSet, basename='users-admin-panel')
router.register(r'alert-types', AlertTypeListView, basename='alert-type')
router.register(r'locations', LocationsViewSet, basename='locations-admin-panel')
router.register(r'locations-type', PointOfInterestTypeListView, basename='location-type-admin-panel')
router.register(r'user-locations', UserLocationsViewSet, basename='user-location-admin-panel')
...
router.register(r'materials', MaterialListView, basename='materials-admin-panel')
