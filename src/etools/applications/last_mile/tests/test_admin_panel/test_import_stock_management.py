...
class TestStockAdminViewSetImport(BaseTenantTestCase):
    ...
    def _create_xlsx_file(self, data_rows, headers=None):
        if headers is None:
            headers = ["Partner Information ", "Stock Level Information ", None, None, None, None, "Location Information (This information can be found in the Admin Module under Manage Locations) "]
