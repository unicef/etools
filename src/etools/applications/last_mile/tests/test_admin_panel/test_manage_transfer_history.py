...
class TestTransferHistoryViewSet(BaseTenantTestCase):
    ...
    def test_get_transfer_history(self):
        ...
        self.assertEqual(response.data.get('results')[0]['unicef_release_order'], transfer_3.unicef_release_order)
        self.assertEqual(response.data.get('results')[1]['unicef_release_order'], transfer_2.unicef_release_order)
        self.assertEqual(response.data.get('results')[2]['unicef_release_order'], self.transfer_1.unicef_release_order)
