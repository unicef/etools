# Generated by Django 4.2.3 on 2025-09-25 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created'],
                'indexes': [models.Index(fields=['item_id'], name='last_mile_i_item_id_2d5800_idx'), models.Index(fields=['action'], name='last_mile_i_action_864823_idx'), models.Index(fields=['user'], name='last_mile_i_user_id_0b510f_idx')],
            },
        ),
    ]
