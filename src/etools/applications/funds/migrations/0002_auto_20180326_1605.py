    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    related_name='frs', to='partners.Intervention', verbose_name='Reference Number'),
        ),
        migrations.AddField(
            model_name='fundscommitmentitem',
            name='fund_commitment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fc_items',
                                    to='funds.FundsCommitmentHeader', verbose_name='Fund Commitment'),
        ),
