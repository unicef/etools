...
class InterventionActivity(BaseInterventionActivity):
    class Meta(BaseInterventionActivity.Meta):
        pass
...
class InterventionActivityItem(BaseInterventionActivityItem):
    class Meta(BaseInterventionActivityItem.Meta):
        pass


class InterventionTimeFrame(BaseInterventionTimeFrame):
    class Meta(BaseInterventionTimeFrame.Meta):
        pass
