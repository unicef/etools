# Generated by Django 2.2.7 on 2021-05-21 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='travel.Trip', verbose_name='Trip')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(blank=True, choices=[('Monitoring Activity', 'Programmatic Visit'), ('Technical Support', 'Technical Support'), ('Meeting', 'Meeting'), ('Staff Development', 'Staff Development'), ('Staff Entitlement', 'Staff Entitlement')], default='Monitoring Activity', max_length=64, verbose_name='Activity Type')),
                ('monitoring_activity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trips', to='field_monitoring_planning.MonitoringActivity')),
                ('partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trips', to='partners.PartnerOrganization')),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trips', to='reports.Section')),
